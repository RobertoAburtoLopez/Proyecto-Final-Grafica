...
public:
    ...
    Model ChickenLittle_cuerpo, ChickenLittle_brazoIzquierdo, ChickenLittle_brazoDerecho, ChickenLittle_pierna;
    Model Chilly_Willy;
    Model Rikoche;
    Model Totoro, TotoroPieIzquierdo, TotoroPieDerecho, TotoroBrazoIzquierdo, TotoroBrazoDerecho;
    ...
    Model LuchaVille_M;
    Model ArbolitosRikochet;
    
    // ------------------------------------------------------------------ === Universo Totoro ===
    Model Totoro_mediano, Totoro_chiquito;;
