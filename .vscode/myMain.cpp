...
// Función - Animacion Chicken Little (caminata)
void animatedChickenLittle()
{
...
int main()
{
	...
	while (!mainWindow.getShouldClose()) // Loop Principal 
	{
		...
		// Chicken Little - partes
		modelChicken = glm::mat4(1.0);
		pos = glm::vec3(0.0f, 0.0f, 0.0f);
		modelChicken = glm::translate(modelChicken, origenChicken + glm::vec3(0, 50, movChicken));
